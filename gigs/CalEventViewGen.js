...
const CONFIG = {
  ...
  DOC_TITLE: "Upcoming Gigs",   // ← Add your document title here. This appears as the heading at the top of the doc.
  TRIM_LOCATION: "full",                 // Location display: true = "City, ST" only | "full" = cleaned full address | false = raw as entered
  DOC_ID: "1hS_PTppKJgoMzkEQztkBz7VKX2NYyzpXA9ypgO5CpuI",   // ← REQUIRED: Google Doc ID (found in the doc URL between "/d/" and "/edit").
  WEB_APP_DEPLOYMENT_ID: "AKfycbz2Fxv1S2wE6FCXjKOZeVHY-CqzZPWWQnEVWy9nO10SjzQsIAsNsoz27IrSYJz-e2nu", // ← REQUIRED for mobile refresh. Generated when you deploy this script as a web app via Deploy > New deployment.

  // ── Date formatting ────────────────────────────────────────
  DATE_PRESET: "custom",                 // "short"      = Mon, Apr 14
  ...
  // ── Time formatting ────────────────────────────────────────
  SHOW_TIME: true,                    // Show start and end time below the date. For all-day events, time is always hidden.
